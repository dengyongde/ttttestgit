...
/* List whoami values for all icm406xx variants*/
...
#if defined(ICM40607)
#define ICM_WHOAMI ICM40607_WHOAMI
#else
#error "Please define which ICM variant is targeted. Possible values: ICM40600, ICM40602, ICM40605, ICM40686, ICM40688, ICM40622, ICM40608, ICM4068"
#endif
...
typedef enum
{
	ICM406XX_CHIP_CONFIG_SPI_MODE_1_2 = (0x1 << BIT_CHIP_CONFIG_SPI_MODE_POS),
	ICM406XX_CHIP_CONFIG_SPI_MODE_0_3 = (0x0 << BIT_CHIP_CONFIG_SPI_MODE_POS),
} ICM406XX_CHIP_CONFIG_SPI_MODE_t;													//retro-compatibility
...
typedef enum
{
	ICM406XX_CHIP_CONFIG_RESET_EN   = 0x01,
	ICM406XX_CHIP_CONFIG_RESET_NONE = 0x00,
} ICM406XX_CHIP_CONFIG_RESET_t;														//retro-compatibility
...
typedef enum
{
	ICM406XX_INT_CONFIG_INT2_DRIVE_CIRCUIT_PP = (0x01 << BIT_INT_CONFIG_INT2_DRIVE_CIRCUIT_POS),
	ICM406XX_INT_CONFIG_INT2_DRIVE_CIRCUIT_OD = (0x00 << BIT_INT_CONFIG_INT2_DRIVE_CIRCUIT_POS),
} ICM406XX_INT_CONFIG_INT2_DRIVE_CIRCUIT_t;
...
typedef enum
{
	ICM406XX_INT_CONFIG_INT2_POLARITY_HIGH = (0x01 << BIT_INT_CONFIG_INT2_POLARITY_POS),
	ICM406XX_INT_CONFIG_INT2_POLARITY_LOW  = (0x00 << BIT_INT_CONFIG_INT2_POLARITY_POS),
} ICM406XX_INT_CONFIG_INT2_POLARITY_t;
...
typedef enum
{
	ICM406XX_FIFO_CONFIG_MODE_STOP_ON_FULL  = (0x02 << BIT_FIFO_CONFIG_MODE_POS),
...
#define ICM406XX_FIFO_CONFIG_MODE_SNAPSHOT = ICM406XX_FIFO_CONFIG_MODE_STOP_ON_FULL; // For retro-compatibility
/*
 * MPUREG_INT_STATUS
...
typedef enum
{
	ICM406XX_APEX_DATA3_ACTIVITY_CLASS_OTHER = 0x0,
	ICM406XX_APEX_DATA3_ACTIVITY_CLASS_WALK  = 0x1,
	ICM406XX_APEX_DATA3_ACTIVITY_CLASS_RUN   = 0x2,
} ICM406XX_APEX_DATA3_ACTIVITY_CLASS_t;
...
typedef enum
{
	ICM406XX_APEX_DATA3_DMP_IDLE_ON     = (0x01 << BIT_APEX_DATA3_DMP_IDLE_POS),
	ICM406XX_APEX_DATA3_DMP_IDLE_OFF    = (0x00 << BIT_APEX_DATA3_DMP_IDLE_POS),
} ICM406XX_APEX_DATA3_DMP_IDLE_OFF_t;
...
typedef enum
{
	ICM406XX_APEX_DATA4_TAP_NUM_DOUBLE = (0x02 << BIT_APEX_DATA4_TAP_NUM_POS),
	ICM406XX_APEX_DATA4_TAP_NUM_SINGLE = (0x01 << BIT_APEX_DATA4_TAP_NUM_POS),
} ICM406XX_APEX_DATA4_TAP_NUM_t;
...
typedef enum
{
	ICM406XX_APEX_DATA4_TAP_AXIS_Z = (0x02 << BIT_APEX_DATA4_TAP_AXIS_POS),
	ICM406XX_APEX_DATA4_TAP_AXIS_Y = (0x01 << BIT_APEX_DATA4_TAP_AXIS_POS),
	ICM406XX_APEX_DATA4_TAP_AXIS_X = (0x00 << BIT_APEX_DATA4_TAP_AXIS_POS),
} ICM406XX_APEX_DATA4_TAP_AXIS_t;
...
typedef enum
{
	ICM406XX_APEX_DATA4_TAP_DIR_POSITIVE = (0x01 << BIT_APEX_DATA4_TAP_DIR_POS),
	ICM406XX_APEX_DATA4_TAP_DIR_NEGATIVE = (0x00 << BIT_APEX_DATA4_TAP_DIR_POS),
} ICM406XX_APEX_DATA4_TAP_DIR_t;
...
typedef enum
{
	ICM406XX_SIGNAL_PATH_RESET_DMP_INIT_EN  = (0x01 << BIT_SIGNAL_PATH_RESET_DMP_INIT_POS),
	ICM406XX_SIGNAL_PATH_RESET_DMP_INIT_DIS = (0x00 << BIT_SIGNAL_PATH_RESET_DMP_INIT_POS),
} ICM406XX_SIGNAL_PATH_RESET_DMP_INIT_t;
...
typedef enum
{
	ICM406XX_SIGNAL_PATH_RESET_DMP_MEM_RESET_EN  = (0x01 << BIT_SIGNAL_PATH_RESET_DMP_MEM_RESET_POS),
	ICM406XX_SIGNAL_PATH_RESET_DMP_MEM_RESET_DIS = (0x00 << BIT_SIGNAL_PATH_RESET_DMP_MEM_RESET_POS),
} ICM406XX_SIGNAL_PATH_RESET_DMP_MEM_RESET_t;
...
typedef enum
{
	ICM406XX_INTF_CONFIG1_ACCEL_LP_CLK_WUOSC = (0x00 << BIT_ACCEL_LP_CLK_SEL_POS),
	ICM406XX_INTF_CONFIG1_ACCEL_LP_CLK_RCOSC = (0x01 << BIT_ACCEL_LP_CLK_SEL_POS),
} ICM406XX_INTF_CONFIG1_ACCEL_LP_CLK_t;
...
typedef enum
{
	ICM406XX_INTF_CONFIG1_RTC_MODE_DIS = (0x00 << BIT_RTC_MODE_POS),
	ICM406XX_INTF_CONFIG1_RTC_MODE_EN  = (0x01 << BIT_RTC_MODE_POS),
} ICM406XX_INTF_CONFIG1_RTC_MODE_t;
...
typedef enum
{
	ICM406XX_PWR_MGMT_0_IDLE_DIS = (0x01 << BIT_PWR_MGMT_0_IDLE_POS),
	ICM406XX_PWR_MGMT_0_IDLE_EN  = (0x00 << BIT_PWR_MGMT_0_IDLE_POS),
} ICM406XX_PWR_MGMT_0_IDLE_t;
...
#define BIT_APEX_CONFIG0_DMP_POWER_SAVE_MASK   (0x1 << BIT_APEX_CONFIG0_DMP_POWER_SAVE_POS)
 ...
 typedef enum
{
	ICM406XX_APEX_CONFIG0_DMP_POWER_SAVE_EN   = (0x1 << BIT_APEX_CONFIG0_DMP_POWER_SAVE_POS),
	ICM406XX_APEX_CONFIG0_DMP_POWER_SAVE_DIS  = (0x0 << BIT_APEX_CONFIG0_DMP_POWER_SAVE_POS),
} ICM406XX_APEX_CONFIG0_DMP_POWER_SAVE_t;
...
#define BIT_APEX_CONFIG0_TAP_ENABLE_MASK   (0x1 << BIT_APEX_CONFIG0_TAP_ENABLE_POS)
 ...
 typedef enum
{
	ICM406XX_APEX_CONFIG0_TAP_ENABLE_EN   = (0x1 << BIT_APEX_CONFIG0_TAP_ENABLE_POS),
	ICM406XX_APEX_CONFIG0_TAP_ENABLE_DIS  = (0x0 << BIT_APEX_CONFIG0_TAP_ENABLE_POS),
} ICM406XX_APEX_CONFIG0_TAP_ENABLE_t;
...
#define BIT_APEX_CONFIG0_PEDO_EN_MASK   (0x1 << BIT_APEX_CONFIG0_PEDO_EN_POS)
 ...
 typedef enum
{
	ICM406XX_APEX_CONFIG0_PEDO_EN_EN   = (0x1 << BIT_APEX_CONFIG0_PEDO_EN_POS),
	ICM406XX_APEX_CONFIG0_PEDO_EN_DIS  = (0x0 << BIT_APEX_CONFIG0_PEDO_EN_POS),
} ICM406XX_APEX_CONFIG0_PEDO_EN_t;
...
#define BIT_APEX_CONFIG0_R2W_EN_MASK   (0x1 << BIT_APEX_CONFIG0_R2W_EN_POS)
 ...
 typedef enum
{
	ICM406XX_APEX_CONFIG0_R2W_EN_EN   = (0x1 << BIT_APEX_CONFIG0_R2W_EN_POS),
	ICM406XX_APEX_CONFIG0_R2W_EN_DIS  = (0x0 << BIT_APEX_CONFIG0_R2W_EN_POS),
} ICM406XX_APEX_CONFIG0_R2W_EN_t;
...
#define BIT_APEX_CONFIG0_TILT_EN_MASK   (0x1 << BIT_APEX_CONFIG0_TILT_EN_POS)
 ...
 typedef enum
{
	ICM406XX_APEX_CONFIG0_TILT_EN_EN   = (0x1 << BIT_APEX_CONFIG0_TILT_EN_POS),
	ICM406XX_APEX_CONFIG0_TILT_EN_DIS  = (0x0 << BIT_APEX_CONFIG0_TILT_EN_POS),
} ICM406XX_APEX_CONFIG0_TILT_EN_t;
...
typedef enum
{
	ICM406XX_APEX_CONFIG0_DMP_ODR_25Hz     = (0x0 << BIT_APEX_CONFIG0_DMP_ODR_POS), /**< 25Hz (40ms) */
	ICM406XX_APEX_CONFIG0_DMP_ODR_50Hz     = (0x2 << BIT_APEX_CONFIG0_DMP_ODR_POS), /**< 50Hz (20ms) */
	ICM406XX_APEX_CONFIG0_DMP_ODR_RESERVED = (0x3 << BIT_APEX_CONFIG0_DMP_ODR_POS), /**< Reserved */
} ICM406XX_APEX_CONFIG0_DMP_ODR_t;
...
typedef enum
{
	ICM406XX_SENSOR_CONFIG2_OIS_MODE_32KHZ = (0x2 << BIT_SENSOR_CONFIG2_OIS_MODE_POS),
	ICM406XX_SENSOR_CONFIG2_OIS_MODE_8KHZ  = (0x1 << BIT_SENSOR_CONFIG2_OIS_MODE_POS),
	ICM406XX_SENSOR_CONFIG2_OIS_MODE_DIS   = (0x0 << BIT_SENSOR_CONFIG2_OIS_MODE_POS)
} ICM406XX_SENSOR_CONFIG2_OIS_MODE_t;
...
typedef enum
{
	ICM406XX_GYRO_AAF_EN  = (0x0 << BIT_GYRO_AAF_DIS_POS),
	ICM406XX_GYRO_AAF_DIS = (0x1 << BIT_GYRO_AAF_DIS_POS),
} ICM406XX_GYRO_AAF_DIS_t;
...
typedef enum
{
	ICM406XX_GYRO_NF_EN  = (0x0 << BIT_GYRO_NF_DIS_POS),
	ICM406XX_GYRO_NF_DIS = (0x1 << BIT_GYRO_NF_DIS_POS),
} ICM406XX_GYRO_NF_DIS_t;
...
typedef enum
{
	ICM406XX_ACCEL_AAF_EN  = (0x0 << BIT_ACCEL_AAF_DIS_POS),
	ICM406XX_ACCEL_AAF_DIS = (0x1 << BIT_ACCEL_AAF_DIS_POS),
} ICM406XX_ACCEL_AAF_DIS_t;
...
typedef enum
{
	ICM406XX_OIS1_CONFIG1_ACCEL_LP_CLK_SEL_WUOSC  = (0x0 << BIT_OIS1_CONFIG1_ACCEL_LP_CLK_SEL_POS),
	ICM406XX_OIS1_CONFIG1_ACCEL_LP_CLK_SEL_RCOSC  = (0x1 << BIT_OIS1_CONFIG1_ACCEL_LP_CLK_SEL_POS),
} ICM406XX_OIS1_CONFIG1_ACCEL_LP_CLK_SEL_t;
...
typedef enum
{
	ICM406XX_OIS1_CONFIG1_DEC_1  = (0x0 << BIT_OIS1_CONFIG1_DEC_POS), /**< OTP_OIS_clock / 1 */
	ICM406XX_OIS1_CONFIG1_DEC_2  = (0x1 << BIT_OIS1_CONFIG1_DEC_POS), /**< OTP_OIS_clock / 2 */
	ICM406XX_OIS1_CONFIG1_DEC_4  = (0x2 << BIT_OIS1_CONFIG1_DEC_POS), /**< OTP_OIS_clock / 4 */
	ICM406XX_OIS1_CONFIG1_DEC_8  = (0x3 << BIT_OIS1_CONFIG1_DEC_POS), /**< OTP_OIS_clock / 8 */
	ICM406XX_OIS1_CONFIG1_DEC_16 = (0x4 << BIT_OIS1_CONFIG1_DEC_POS), /**< OTP_OIS_clock / 16 */
	ICM406XX_OIS1_CONFIG1_DEC_32 = (0x5 << BIT_OIS1_CONFIG1_DEC_POS), /**< OTP_OIS_clock / 32 */
...
typedef enum
{
	ICM406XX_OIS1_CONFIG1_ACCEL_EN  = (0x1 << BIT_OIS1_CONFIG1_ACCEL_EN_POS),
	ICM406XX_OIS1_CONFIG1_ACCEL_DIS = (0x0 << BIT_OIS1_CONFIG1_ACCEL_EN_POS),
} ICM406XX_OIS1_CONFIG1_ACCEL_EN_t;
...
typedef enum
{
	ICM406XX_OIS1_CONFIG2_GYRO_FS_SEL_16dps   = (0x7 << BIT_OIS1_CONFIG2_GYRO_FS_SEL_POS), /**< 15.625 dps */
	ICM406XX_OIS1_CONFIG2_GYRO_FS_SEL_31dps   = (0x6 << BIT_OIS1_CONFIG2_GYRO_FS_SEL_POS), /**< 31.25 dps */
	ICM406XX_OIS1_CONFIG2_GYRO_FS_SEL_62dps   = (0x5 << BIT_OIS1_CONFIG2_GYRO_FS_SEL_POS), /**< 62.5 dps */
	ICM406XX_OIS1_CONFIG2_GYRO_FS_SEL_125dps  = (0x4 << BIT_OIS1_CONFIG2_GYRO_FS_SEL_POS), /**< 125 dps */
	ICM406XX_OIS1_CONFIG2_GYRO_FS_SEL_250dps  = (0x3 << BIT_OIS1_CONFIG2_GYRO_FS_SEL_POS), /**< 250 dps */
	ICM406XX_OIS1_CONFIG2_GYRO_FS_SEL_500dps  = (0x2 << BIT_OIS1_CONFIG2_GYRO_FS_SEL_POS), /**< 500 dps */
	ICM406XX_OIS1_CONFIG2_GYRO_FS_SEL_1000dps = (0x1 << BIT_OIS1_CONFIG2_GYRO_FS_SEL_POS), /**< 1000 dps */
	ICM406XX_OIS1_CONFIG2_GYRO_FS_SEL_2000dps = (0x0 << BIT_OIS1_CONFIG2_GYRO_FS_SEL_POS), /**< 2000 dps */
...
typedef enum
{
	ICM406XX_OIS1_CONFIG2_ACCEL_FS_SEL_RESERVED  = (0x4 << BIT_OIS1_CONFIG2_ACCEL_FS_SEL_POS),
	ICM406XX_OIS1_CONFIG2_ACCEL_FS_SEL_2g        = (0x3 << BIT_OIS1_CONFIG2_ACCEL_FS_SEL_POS), /**< 2g */
	ICM406XX_OIS1_CONFIG2_ACCEL_FS_SEL_4g        = (0x2 << BIT_OIS1_CONFIG2_ACCEL_FS_SEL_POS), /**< 4g */
	ICM406XX_OIS1_CONFIG2_ACCEL_FS_SEL_8g        = (0x1 << BIT_OIS1_CONFIG2_ACCEL_FS_SEL_POS), /**< 8g */
	ICM406XX_OIS1_CONFIG2_ACCEL_FS_SEL_16g       = (0x0 << BIT_OIS1_CONFIG2_ACCEL_FS_SEL_POS), /**< 16g */
} ICM406XX_OIS1_CONFIG2_ACCEL_FS_SEL_t;
...
typedef enum
{
	ICM406XX_OIS2_CONFIG1_ACCEL_LP_CLK_SEL_WUOSC  = (0x0 << BIT_OIS2_CONFIG1_ACCEL_LP_CLK_SEL_POS),
	ICM406XX_OIS2_CONFIG1_ACCEL_LP_CLK_SEL_RCOSC  = (0x1 << BIT_OIS2_CONFIG1_ACCEL_LP_CLK_SEL_POS),
} ICM406XX_OIS2_CONFIG1_ACCEL_LP_CLK_SEL_t;
...
typedef enum
{
	ICM406XX_OIS2_CONFIG1_DEC_1  = (0x0 << BIT_OIS2_CONFIG1_DEC_POS), /**< OTP_OIS_clock / 1 */
	ICM406XX_OIS2_CONFIG1_DEC_2  = (0x1 << BIT_OIS2_CONFIG1_DEC_POS), /**< OTP_OIS_clock / 2 */
	ICM406XX_OIS2_CONFIG1_DEC_4  = (0x2 << BIT_OIS2_CONFIG1_DEC_POS), /**< OTP_OIS_clock / 4 */
	ICM406XX_OIS2_CONFIG1_DEC_8  = (0x3 << BIT_OIS2_CONFIG1_DEC_POS), /**< OTP_OIS_clock / 8 */
	ICM406XX_OIS2_CONFIG1_DEC_16 = (0x4 << BIT_OIS2_CONFIG1_DEC_POS), /**< OTP_OIS_clock / 16 */
	ICM406XX_OIS2_CONFIG1_DEC_32 = (0x5 << BIT_OIS2_CONFIG1_DEC_POS), /**< OTP_OIS_clock / 32 */
...
typedef enum
{
	ICM406XX_OIS2_CONFIG1_ACCEL_EN  = (0x1 << BIT_OIS2_CONFIG1_ACCEL_EN_POS),
	ICM406XX_OIS2_CONFIG1_ACCEL_DIS = (0x0 << BIT_OIS2_CONFIG1_ACCEL_EN_POS),
} ICM406XX_OIS2_CONFIG1_ACCEL_EN_t;
...
typedef enum
{
	ICM406XX_OIS2_CONFIG2_GYRO_FS_SEL_16dps   = (0x7 << BIT_OIS2_CONFIG2_GYRO_FS_SEL_POS), /**< 15.625 dps */
	ICM406XX_OIS2_CONFIG2_GYRO_FS_SEL_31dps   = (0x6 << BIT_OIS2_CONFIG2_GYRO_FS_SEL_POS), /**< 31.25 dps */
	ICM406XX_OIS2_CONFIG2_GYRO_FS_SEL_62dps   = (0x5 << BIT_OIS2_CONFIG2_GYRO_FS_SEL_POS), /**< 62.5 dps */
	ICM406XX_OIS2_CONFIG2_GYRO_FS_SEL_125dps  = (0x4 << BIT_OIS2_CONFIG2_GYRO_FS_SEL_POS), /**< 125 dps */
	ICM406XX_OIS2_CONFIG2_GYRO_FS_SEL_250dps  = (0x3 << BIT_OIS2_CONFIG2_GYRO_FS_SEL_POS), /**< 250 dps */
	ICM406XX_OIS2_CONFIG2_GYRO_FS_SEL_500dps  = (0x2 << BIT_OIS2_CONFIG2_GYRO_FS_SEL_POS), /**< 500 dps */
	ICM406XX_OIS2_CONFIG2_GYRO_FS_SEL_1000dps = (0x1 << BIT_OIS2_CONFIG2_GYRO_FS_SEL_POS), /**< 1000 dps */
	ICM406XX_OIS2_CONFIG2_GYRO_FS_SEL_2000dps = (0x0 << BIT_OIS2_CONFIG2_GYRO_FS_SEL_POS), /**< 2000 dps */
...
typedef enum
{
	ICM406XX_OIS2_CONFIG2_ACCEL_FS_SEL_RESERVED  = (0x4 << BIT_OIS2_CONFIG2_ACCEL_FS_SEL_POS),
	ICM406XX_OIS2_CONFIG2_ACCEL_FS_SEL_2g        = (0x3 << BIT_OIS2_CONFIG2_ACCEL_FS_SEL_POS), /**< 2g */
	ICM406XX_OIS2_CONFIG2_ACCEL_FS_SEL_4g        = (0x2 << BIT_OIS2_CONFIG2_ACCEL_FS_SEL_POS), /**< 4g */
	ICM406XX_OIS2_CONFIG2_ACCEL_FS_SEL_8g        = (0x1 << BIT_OIS2_CONFIG2_ACCEL_FS_SEL_POS), /**< 8g */
	ICM406XX_OIS2_CONFIG2_ACCEL_FS_SEL_16g       = (0x0 << BIT_OIS2_CONFIG2_ACCEL_FS_SEL_POS), /**< 16g */
} ICM406XX_OIS2_CONFIG2_ACCEL_FS_SEL_t;
...
typedef enum
{
	ICM406XX_APEX_CONFIG1_DMP_POWER_SAVE_TIME_SEL_0S  = 0x0,
	ICM406XX_APEX_CONFIG1_DMP_POWER_SAVE_TIME_SEL_4S  = 0x1,
	ICM406XX_APEX_CONFIG1_DMP_POWER_SAVE_TIME_SEL_8S  = 0x2,
	ICM406XX_APEX_CONFIG1_DMP_POWER_SAVE_TIME_SEL_12S = 0x3,
	ICM406XX_APEX_CONFIG1_DMP_POWER_SAVE_TIME_SEL_16S = 0x4,
	ICM406XX_APEX_CONFIG1_DMP_POWER_SAVE_TIME_SEL_20S = 0x5,
	ICM406XX_APEX_CONFIG1_DMP_POWER_SAVE_TIME_SEL_24S = 0x6,
	ICM406XX_APEX_CONFIG1_DMP_POWER_SAVE_TIME_SEL_28S = 0x7,
	ICM406XX_APEX_CONFIG1_DMP_POWER_SAVE_TIME_SEL_32S = 0x8,
	ICM406XX_APEX_CONFIG1_DMP_POWER_SAVE_TIME_SEL_36S = 0x9,
	ICM406XX_APEX_CONFIG1_DMP_POWER_SAVE_TIME_SEL_40S = 0xA,
	ICM406XX_APEX_CONFIG1_DMP_POWER_SAVE_TIME_SEL_44S = 0xB,
	ICM406XX_APEX_CONFIG1_DMP_POWER_SAVE_TIME_SEL_48S = 0xC,
	ICM406XX_APEX_CONFIG1_DMP_POWER_SAVE_TIME_SEL_52S = 0xD,
	ICM406XX_APEX_CONFIG1_DMP_POWER_SAVE_TIME_SEL_56S = 0xE,
	ICM406XX_APEX_CONFIG1_DMP_POWER_SAVE_TIME_SEL_60S = 0xF
} ICM406XX_APEX_CONFIG1_DMP_POWER_SAVE_TIME_t;
...
typedef enum
{
	ICM406XX_APEX_CONFIG1_LOW_ENERGY_AMP_TH_SEL_1006632MG = (0 << BIT_APEX_CONFIG1_LOW_ENERGY_AMP_TH_SEL_POS),
	ICM406XX_APEX_CONFIG1_LOW_ENERGY_AMP_TH_SEL_1174405MG = (1 << BIT_APEX_CONFIG1_LOW_ENERGY_AMP_TH_SEL_POS),
	ICM406XX_APEX_CONFIG1_LOW_ENERGY_AMP_TH_SEL_1342177MG = (2 << BIT_APEX_CONFIG1_LOW_ENERGY_AMP_TH_SEL_POS),
	ICM406XX_APEX_CONFIG1_LOW_ENERGY_AMP_TH_SEL_1509949MG = (3 << BIT_APEX_CONFIG1_LOW_ENERGY_AMP_TH_SEL_POS),
	ICM406XX_APEX_CONFIG1_LOW_ENERGY_AMP_TH_SEL_1677721MG = (4 << BIT_APEX_CONFIG1_LOW_ENERGY_AMP_TH_SEL_POS),
	ICM406XX_APEX_CONFIG1_LOW_ENERGY_AMP_TH_SEL_1845493MG = (5 << BIT_APEX_CONFIG1_LOW_ENERGY_AMP_TH_SEL_POS),
	ICM406XX_APEX_CONFIG1_LOW_ENERGY_AMP_TH_SEL_2013265MG = (6 << BIT_APEX_CONFIG1_LOW_ENERGY_AMP_TH_SEL_POS),
	ICM406XX_APEX_CONFIG1_LOW_ENERGY_AMP_TH_SEL_2181038MG = (7 << BIT_APEX_CONFIG1_LOW_ENERGY_AMP_TH_SEL_POS),
	ICM406XX_APEX_CONFIG1_LOW_ENERGY_AMP_TH_SEL_2348810MG = (8 << BIT_APEX_CONFIG1_LOW_ENERGY_AMP_TH_SEL_POS),
	ICM406XX_APEX_CONFIG1_LOW_ENERGY_AMP_TH_SEL_2516582MG = (9 << BIT_APEX_CONFIG1_LOW_ENERGY_AMP_TH_SEL_POS),
	ICM406XX_APEX_CONFIG1_LOW_ENERGY_AMP_TH_SEL_2684354MG = (10 << BIT_APEX_CONFIG1_LOW_ENERGY_AMP_TH_SEL_POS),
	ICM406XX_APEX_CONFIG1_LOW_ENERGY_AMP_TH_SEL_2852126MG = (11 << BIT_APEX_CONFIG1_LOW_ENERGY_AMP_TH_SEL_POS),
	ICM406XX_APEX_CONFIG1_LOW_ENERGY_AMP_TH_SEL_3019898MG = (12 << BIT_APEX_CONFIG1_LOW_ENERGY_AMP_TH_SEL_POS),
	ICM406XX_APEX_CONFIG1_LOW_ENERGY_AMP_TH_SEL_3187671MG = (13 << BIT_APEX_CONFIG1_LOW_ENERGY_AMP_TH_SEL_POS),
	ICM406XX_APEX_CONFIG1_LOW_ENERGY_AMP_TH_SEL_3355443MG = (14 << BIT_APEX_CONFIG1_LOW_ENERGY_AMP_TH_SEL_POS),
	ICM406XX_APEX_CONFIG1_LOW_ENERGY_AMP_TH_SEL_3523215MG = (15 << BIT_APEX_CONFIG1_LOW_ENERGY_AMP_TH_SEL_POS)
} ICM406XX_APEX_CONFIG1_LOW_ENERGY_AMP_TH_t;
...
typedef enum
{
	ICM406XX_APEX_CONFIG2_PEDO_AMP_TH_1006632_MG = (0  << BIT_APEX_CONFIG2_PEDO_AMP_TH_POS),
	ICM406XX_APEX_CONFIG2_PEDO_AMP_TH_1140850_MG = (1  << BIT_APEX_CONFIG2_PEDO_AMP_TH_POS),
	ICM406XX_APEX_CONFIG2_PEDO_AMP_TH_1275068_MG = (2  << BIT_APEX_CONFIG2_PEDO_AMP_TH_POS),
	ICM406XX_APEX_CONFIG2_PEDO_AMP_TH_1409286_MG = (3  << BIT_APEX_CONFIG2_PEDO_AMP_TH_POS),
	ICM406XX_APEX_CONFIG2_PEDO_AMP_TH_1543503_MG = (4  << BIT_APEX_CONFIG2_PEDO_AMP_TH_POS),
	ICM406XX_APEX_CONFIG2_PEDO_AMP_TH_1677721_MG = (5  << BIT_APEX_CONFIG2_PEDO_AMP_TH_POS),
	ICM406XX_APEX_CONFIG2_PEDO_AMP_TH_1811939_MG = (6  << BIT_APEX_CONFIG2_PEDO_AMP_TH_POS),
	ICM406XX_APEX_CONFIG2_PEDO_AMP_TH_1946157_MG = (7  << BIT_APEX_CONFIG2_PEDO_AMP_TH_POS),
	ICM406XX_APEX_CONFIG2_PEDO_AMP_TH_2080374_MG = (8  << BIT_APEX_CONFIG2_PEDO_AMP_TH_POS),
	ICM406XX_APEX_CONFIG2_PEDO_AMP_TH_2214592_MG = (9  << BIT_APEX_CONFIG2_PEDO_AMP_TH_POS),
	ICM406XX_APEX_CONFIG2_PEDO_AMP_TH_2348810_MG = (10 << BIT_APEX_CONFIG2_PEDO_AMP_TH_POS),
	ICM406XX_APEX_CONFIG2_PEDO_AMP_TH_2483027_MG = (11 << BIT_APEX_CONFIG2_PEDO_AMP_TH_POS),
	ICM406XX_APEX_CONFIG2_PEDO_AMP_TH_2617245_MG = (12 << BIT_APEX_CONFIG2_PEDO_AMP_TH_POS),
	ICM406XX_APEX_CONFIG2_PEDO_AMP_TH_2751463_MG = (13 << BIT_APEX_CONFIG2_PEDO_AMP_TH_POS),
	ICM406XX_APEX_CONFIG2_PEDO_AMP_TH_2885681_MG = (14 << BIT_APEX_CONFIG2_PEDO_AMP_TH_POS),
	ICM406XX_APEX_CONFIG2_PEDO_AMP_TH_3019898_MG = (15 << BIT_APEX_CONFIG2_PEDO_AMP_TH_POS)
} ICM406XX_APEX_CONFIG2_PEDO_AMP_TH_t;
...
typedef enum
{
	ICM406XX_APEX_CONFIG3_PEDO_SB_TIMER_TH_50_SAMPLES  = (0  << BIT_APEX_CONFIG3_PEDO_SB_TIMER_TH_POS),
	ICM406XX_APEX_CONFIG3_PEDO_SB_TIMER_TH_75_SAMPLES  = (1  << BIT_APEX_CONFIG3_PEDO_SB_TIMER_TH_POS),
	ICM406XX_APEX_CONFIG3_PEDO_SB_TIMER_TH_100_SAMPLES = (2  << BIT_APEX_CONFIG3_PEDO_SB_TIMER_TH_POS),
	ICM406XX_APEX_CONFIG3_PEDO_SB_TIMER_TH_125_SAMPLES = (3  << BIT_APEX_CONFIG3_PEDO_SB_TIMER_TH_POS),
	ICM406XX_APEX_CONFIG3_PEDO_SB_TIMER_TH_150_SAMPLES = (4  << BIT_APEX_CONFIG3_PEDO_SB_TIMER_TH_POS),
	ICM406XX_APEX_CONFIG3_PEDO_SB_TIMER_TH_175_SAMPLES = (5  << BIT_APEX_CONFIG3_PEDO_SB_TIMER_TH_POS),
	ICM406XX_APEX_CONFIG3_PEDO_SB_TIMER_TH_200_SAMPLES = (6  << BIT_APEX_CONFIG3_PEDO_SB_TIMER_TH_POS),
	ICM406XX_APEX_CONFIG3_PEDO_SB_TIMER_TH_225_SAMPLES = (7  << BIT_APEX_CONFIG3_PEDO_SB_TIMER_TH_POS)
} ICM406XX_APEX_CONFIG3_PEDO_SB_TIMER_TH_t;
...
typedef enum
{
	ICM406XX_APEX_CONFIG3_PEDO_HI_ENRGY_TH_90  = 0x0,
	ICM406XX_APEX_CONFIG3_PEDO_HI_ENRGY_TH_107 = 0x1,
	ICM406XX_APEX_CONFIG3_PEDO_HI_ENRGY_TH_136 = 0x2,
	ICM406XX_APEX_CONFIG3_PEDO_HI_ENRGY_TH_159 = 0x3
} ICM406XX_APEX_CONFIG3_PEDO_HI_ENRGY_TH_t;
...
typedef enum
{
	ICM406XX_APEX_CONFIG4_TILT_WAIT_TIME_0  = (0  << BIT_APEX_CONFIG4_TILT_WAIT_TIME_POS),
	ICM406XX_APEX_CONFIG4_TILT_WAIT_TIME_2S = (1  << BIT_APEX_CONFIG4_TILT_WAIT_TIME_POS),
	ICM406XX_APEX_CONFIG4_TILT_WAIT_TIME_4S = (2  << BIT_APEX_CONFIG4_TILT_WAIT_TIME_POS),
	ICM406XX_APEX_CONFIG4_TILT_WAIT_TIME_6S = (3  << BIT_APEX_CONFIG4_TILT_WAIT_TIME_POS)
} ICM406XX_APEX_CONFIG4_TILT_WAIT_TIME_t;
...
typedef enum
{
	ICM406XX_APEX_CONFIG4_R2W_SLEEP_TIME_OUT_1_28S  = (0  << BIT_APEX_CONFIG4_R2W_SLEEP_TIME_OUT_POS),
	ICM406XX_APEX_CONFIG4_R2W_SLEEP_TIME_OUT_2_56S  = (1  << BIT_APEX_CONFIG4_R2W_SLEEP_TIME_OUT_POS),
	ICM406XX_APEX_CONFIG4_R2W_SLEEP_TIME_OUT_3_84S  = (2  << BIT_APEX_CONFIG4_R2W_SLEEP_TIME_OUT_POS),
	ICM406XX_APEX_CONFIG4_R2W_SLEEP_TIME_OUT_5_12S  = (3  << BIT_APEX_CONFIG4_R2W_SLEEP_TIME_OUT_POS),
	ICM406XX_APEX_CONFIG4_R2W_SLEEP_TIME_OUT_6_4S   = (4  << BIT_APEX_CONFIG4_R2W_SLEEP_TIME_OUT_POS),
	ICM406XX_APEX_CONFIG4_R2W_SLEEP_TIME_OUT_7_68S  = (5  << BIT_APEX_CONFIG4_R2W_SLEEP_TIME_OUT_POS),
	ICM406XX_APEX_CONFIG4_R2W_SLEEP_TIME_OUT_8_96S  = (6  << BIT_APEX_CONFIG4_R2W_SLEEP_TIME_OUT_POS),
	ICM406XX_APEX_CONFIG4_R2W_SLEEP_TIME_OUT_10_24S = (7  << BIT_APEX_CONFIG4_R2W_SLEEP_TIME_OUT_POS)
} ICM406XX_APEX_CONFIG4_R2W_SLEEP_TIME_OUT_t;
...
typedef enum
{
	ICM406XX_APEX_CONFIG5_R2W_MOUNTING_MATRIX_0 = (0  << BIT_APEX_CONFIG5_R2W_MOUNTING_MATRIX_POS),
	ICM406XX_APEX_CONFIG5_R2W_MOUNTING_MATRIX_1 = (1  << BIT_APEX_CONFIG5_R2W_MOUNTING_MATRIX_POS),
	ICM406XX_APEX_CONFIG5_R2W_MOUNTING_MATRIX_2 = (2  << BIT_APEX_CONFIG5_R2W_MOUNTING_MATRIX_POS),
	ICM406XX_APEX_CONFIG5_R2W_MOUNTING_MATRIX_3 = (3  << BIT_APEX_CONFIG5_R2W_MOUNTING_MATRIX_POS),
	ICM406XX_APEX_CONFIG5_R2W_MOUNTING_MATRIX_4 = (4  << BIT_APEX_CONFIG5_R2W_MOUNTING_MATRIX_POS),
	ICM406XX_APEX_CONFIG5_R2W_MOUNTING_MATRIX_5 = (5  << BIT_APEX_CONFIG5_R2W_MOUNTING_MATRIX_POS),
	ICM406XX_APEX_CONFIG5_R2W_MOUNTING_MATRIX_6 = (6  << BIT_APEX_CONFIG5_R2W_MOUNTING_MATRIX_POS),
	ICM406XX_APEX_CONFIG5_R2W_MOUNTING_MATRIX_7 = (7  << BIT_APEX_CONFIG5_R2W_MOUNTING_MATRIX_POS)
} ICM406XX_APEX_CONFIG5_R2W_MOUNTING_MATRIX_t;
...
typedef enum
{
	ICM406XX_APEX_CONFIG6_R2W_SLEEP_GEST_DELAY_0_32S  = (0  << BIT_APEX_CONFIG6_R2W_SLEEP_GEST_DELAY_POS),
	ICM406XX_APEX_CONFIG6_R2W_SLEEP_GEST_DELAY_0_64S  = (1  << BIT_APEX_CONFIG6_R2W_SLEEP_GEST_DELAY_POS),
	ICM406XX_APEX_CONFIG6_R2W_SLEEP_GEST_DELAY_0_96S  = (2  << BIT_APEX_CONFIG6_R2W_SLEEP_GEST_DELAY_POS),
	ICM406XX_APEX_CONFIG6_R2W_SLEEP_GEST_DELAY_1_28S  = (3  << BIT_APEX_CONFIG6_R2W_SLEEP_GEST_DELAY_POS),
	ICM406XX_APEX_CONFIG6_R2W_SLEEP_GEST_DELAY_1_6S   = (4  << BIT_APEX_CONFIG6_R2W_SLEEP_GEST_DELAY_POS),
	ICM406XX_APEX_CONFIG6_R2W_SLEEP_GEST_DELAY_1_92S  = (5  << BIT_APEX_CONFIG6_R2W_SLEEP_GEST_DELAY_POS),
	ICM406XX_APEX_CONFIG6_R2W_SLEEP_GEST_DELAY_2_24S  = (6  << BIT_APEX_CONFIG6_R2W_SLEEP_GEST_DELAY_POS),
	ICM406XX_APEX_CONFIG6_R2W_SLEEP_GEST_DELAY_2_56S  = (7  << BIT_APEX_CONFIG6_R2W_SLEEP_GEST_DELAY_POS)
} ICM406XX_APEX_CONFIG6_R2W_SLEEP_GEST_DELAY_t;
...
#define ICM406XX_APEX_CONFIG7_TAP_MIN_JERK_THR_281MG_DEFAULT    0x11
...
typedef enum
{
	ICM406XX_APEX_CONFIG7_TAP_MAX_PEAK_TOL_12 = 0x0,
	ICM406XX_APEX_CONFIG7_TAP_MAX_PEAK_TOL_25 = 0x1,
	ICM406XX_APEX_CONFIG7_TAP_MAX_PEAK_TOL_37 = 0x2,
	ICM406XX_APEX_CONFIG7_TAP_MAX_PEAK_TOL_50 = 0x3
} ICM406XX_APEX_CONFIG7_TAP_MAX_PEAK_TOL_t;
...
typedef enum
{
	ICM406XX_APEX_CONFIG8_TAP_TMAX_250MS = (0 << BIT_APEX_CONFIG8_TAP_TMAX_POS),
	ICM406XX_APEX_CONFIG8_TAP_TMAX_375MS = (1 << BIT_APEX_CONFIG8_TAP_TMAX_POS),
	ICM406XX_APEX_CONFIG8_TAP_TMAX_500MS = (2 << BIT_APEX_CONFIG8_TAP_TMAX_POS),
	ICM406XX_APEX_CONFIG8_TAP_TMAX_625MS = (3 << BIT_APEX_CONFIG8_TAP_TMAX_POS)
} ICM406XX_APEX_CONFIG8_TAP_TMAX_t;
...
typedef enum
{
	ICM406XX_APEX_CONFIG8_TAP_TAVG_1SAMPLE = (0 << BIT_APEX_CONFIG8_TAP_TAVG_POS),
	ICM406XX_APEX_CONFIG8_TAP_TAVG_2SAMPLE = (1 << BIT_APEX_CONFIG8_TAP_TAVG_POS),
	ICM406XX_APEX_CONFIG8_TAP_TAVG_4SAMPLE = (2 << BIT_APEX_CONFIG8_TAP_TAVG_POS),
	ICM406XX_APEX_CONFIG8_TAP_TAVG_8SAMPLE = (3 << BIT_APEX_CONFIG8_TAP_TAVG_POS)
} ICM406XX_APEX_CONFIG8_TAP_TAVG_t;
...
typedef enum
{
	ICM406XX_APEX_CONFIG8_TAP_TMIN_125MS = 0x0,
	ICM406XX_APEX_CONFIG8_TAP_TMIN_140MS = 0x1,
	ICM406XX_APEX_CONFIG8_TAP_TMIN_156MS = 0x2,
	ICM406XX_APEX_CONFIG8_TAP_TMIN_171MS = 0x3,
	ICM406XX_APEX_CONFIG8_TAP_TMIN_187MS = 0x4,
	ICM406XX_APEX_CONFIG8_TAP_TMIN_203MS = 0x5,
	ICM406XX_APEX_CONFIG8_TAP_TMIN_218MS = 0x6,
	ICM406XX_APEX_CONFIG8_TAP_TMIN_234MS = 0x7
} ICM406XX_APEX_CONFIG8_TAP_TMIN_t;
...
typedef enum
{
	ICM406XX_APEX_CONFIG9_SENSITIVITY_MODE_NORMAL   = 0x00,
	ICM406XX_APEX_CONFIG9_SENSITIVITY_MODE_RESERVED = 0x01
} ICM406XX_APEX_CONFIG9_SENSITIVITY_MODE_t;
