...
struct inv_icm406xx_serif {
	...
	int      (*read_reg)(struct inv_icm406xx_serif * serif, uint8_t reg, uint8_t * buf, uint32_t len);
	int      (*write_reg)(struct inv_icm406xx_serif * serif, uint8_t reg, const uint8_t * buf, uint32_t len);
	int      (*configure)(struct inv_icm406xx_serif * serif);
	uint32_t   max_read;
	uint32_t   max_write;
 ...
 */
struct inv_icm406xx_transport {
	struct inv_icm406xx_serif serif; /**< Warning : this field MUST be the first one of struct inv_icm406xx_transport */
